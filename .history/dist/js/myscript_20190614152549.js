...
var UIController = (function(){
    ...
    return {
        ...
        exploreAppRowHeight: function(sample, parent, repeat, heading) {
            ...
            parentElement.style.gridTemplateRows = `${heading} repeat(${repeat}, ${elementHeight})` ;
...
var controller = (function(UICtrl){
    ...
    var setupEventListeners = function() {
        ...
        window.onload = function() {
            UICtrl.windowResize();
            UICtrl.exploreAppRowHeight(DOM.boxSize, DOM.expWireFrame, 2, auto);
            UICtrl.exploreAppRowHeight(DOM.boxSize, DOM.expTypographySection, 2, auto);
