...
var UIController = (function(){
    ...
    return {
        ...
        exploreBoxHeight: function(sample, box) {
        ...
        windowResize: function() {
            ...
            if(windowWidth > 1280) {
                ...
                UIController.exploreAppRowHeight(DOMstrings.boxSize, DOMstrings.expIntroduction, 5);
                UIController.exploreAppRowHeight(DOMstrings.boxSize, DOMstrings.expWireFrame, 10, "auto");
                UIController.exploreAppRowHeight(DOMstrings.expProjectDescription, DOMstrings.expProjectInfo, 2, 'auto');
                
                console.log(`smaller screen`);
            } else if (windowWidth < 769) {
                console.log(`smarthPhone ${windowWidth}`);
                UIController.exploreAppRowHeight(DOMstrings.boxSize, DOMstrings.expIntroduction, 4);
            }
