...
var UIController = (function(){
    ...
    return {
        ...
        exploreAppRowHeight: function(sampleBox) {
            var elm = document.querySelector(sampleBox);
            var elementHeight = elm.innerWidth;
            elm.style.height = elementHeight + 'px';
...
var controller = (function(UICtrl){
    ...
    var setupEventListeners = function() {
        ...
        window.onload = function() {
            UICtrl.windowResize();
            UICtrl.exploreAppRowHeight(DOM.boxSize);
        }
