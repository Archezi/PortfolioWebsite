...
var UIController = (function(){
    ...
    return {
        ...
        exploreAppRowHeight: function(sample, parent) {
...
var controller = (function(UICtrl){
    ...
    var setupEventListeners = function() {
        ...
        window.onload = function() {
            UICtrl.windowResize();
            UICtrl.exploreAppRowHeight(DOM.boxSize, DOM.expWireFrame);
            UICtrl.exploreAppRowHeight(DOM.boxSize, DOM.expTypographySection);
            UICtrl.exploreAppRowHeight(DOM.boxSize, DOM.expStyleGuide);
        }
